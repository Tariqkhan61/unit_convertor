...
st.markdown("<h1> ⚖️Unit:📐🧪📏: Convertor using Python and 🚣 Streamlit </>", unsafe_allow_html=True)
...
if st.button("👾 Convert"):
    ...
    st.markdown("<div class='footer'>Created by:🌼: Muhammad Tariq Mahboob ©️®️</div>", unsafe_allow_html=True)
